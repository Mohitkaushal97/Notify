"""
Django settings for pushapp project.
...
SECRET_KEY = 'i!be^)2wphfuuftm13o6a+ews(wb34ry73ad!wd*#3c6s$+zz1'
...
WSGI_APPLICATION = 'pushapp.wsgi.application'
